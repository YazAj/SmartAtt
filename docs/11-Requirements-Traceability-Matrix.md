...
| R-110 | Localization resources for reports | `SharedResource.en-US.resx`, `SharedResource.ar-JO.resx`, report views | Build, runtime HTML smoke | Partially verified | English/Arabic resources compile; runtime smoke observed Admin report shell `lang`/`dir`; full manual text review remains pending. |
| R-111 | Dark/light responsive report UI | `site.css`, report views | Code review, pending manual browser matrix | Partially verified | Tokenized CSS and responsive tables are implemented; full desktop/tablet/390px/320px dark/light visual proof is pending. |
| R-112 | Live SQL Student/Instructor report walkthrough | Student and Instructor report routes | Integration tests; pending live SQL manual walkthrough | Partially verified | Automated route-owner tests pass; live SQL-backed Student and Instructor report/export sessions were not executed in this closure pass. |
...
| G-05 | Sprint 7 manual visual/accessibility closure | Partially verified | Complete English/Arabic, LTR/RTL, dark/light, desktop/tablet/390px/320px, keyboard, and print browser checks. |
| G-06 | Live SQL Student/Instructor report closure | Partially verified | Execute Student and Instructor report/export walkthroughs against a SQL Server database with linked academic profiles and attendance records. |
